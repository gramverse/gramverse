...
export class CommentRepService {
    ...
    commentLikeExists = async (userName: string, commentId: string) => {
        return await this.commentLikeRepository.commentslikeExists(
            userName,
            commentId,
        );
    };
    ...
    getCommentLike = async (userName: string, commentId: string) => {
        return await this.commentLikeRepository.getCommentLike(
            userName,
            commentId,
        );
    };
    ...
    undeleteCommentLike = async (userName: string, commentId: string) => {
        return await this.commentLikeRepository.undeleteCommentLike(
            userName,
            commentId,
        );
    };
    ...
    deleteCommentLike = async (userName: string, commentId: string) => {
        return await this.commentLikeRepository.deleteCommentLike(
            userName,
            commentId,
        );
    };
