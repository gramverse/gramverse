...
export const followRepService = new FollowRepService(followRepository, userRepService);
export const postRepService = new PostRepService(postRepository);
export const eventService = new EventService(eventRepository);
export const notificationService = new NotificationService(notificationRepository, eventService, userRepService, followRepService, postRepService, commentRepository)
export const followService = new FollowService(followRepService, userRepService, notificationService, blockRepository);
export const postService = new PostService(followRepService, postRepService, userRepService, tagRepository, commentRepository, bookmarkRepository, likesRepository, commentslikeRepository, bookmarkRepository, notificationService)
export const userService = new UserService(postService, userRepService, postRepository, tokenRepository, followRepository, notificationService);
export const resetService = new ResetService(tokenRepository, userRepService, emailService);
